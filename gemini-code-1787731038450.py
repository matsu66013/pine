...
<body>
  ...
  <div class="highlight-container">
    ...
    <div class="hero-box salary-box">
      ...
      <div class="salary-amount">
        <span class="unit-text">年収</span> 450<span class="unit-text">万円</span> ～ 550<span class="unit-text">万円</span>
      </div>
  ...
  <div class="features-grid">
    <table style="width:100%; border-spacing: 5px 0; border-collapse: separate;">
      <tr>
...
html_file_path = 'recruitment_poster_v3.html'
pdf_file_path = 'recruitment_poster_v3.pdf'
